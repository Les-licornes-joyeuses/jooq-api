...
public class RecordRecv extends AbstractRoutine<Record> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.record_recv.RETURN_VALUE</code>.
     */
     ...
     */
    public RecordRecv() {
        super("record_recv", PgCatalog.PG_CATALOG, SQLDataType.RECORD);
