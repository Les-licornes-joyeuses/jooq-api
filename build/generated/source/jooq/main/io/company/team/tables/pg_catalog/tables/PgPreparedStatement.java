...
public class PgPreparedStatement extends TableImpl<PgPreparedStatementRecord> {
     ...
     */
    public final TableField<PgPreparedStatementRecord, Object[]> RESULT_TYPES = createField(DSL.name("result_types"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regtype\"").getArrayDataType(), this, "");
