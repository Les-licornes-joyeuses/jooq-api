...
import io.company.team.tables.pg_catalog.tables.records.PgPreparedStatementsRecord;
...
public class PgPreparedStatements extends TableImpl<PgPreparedStatementsRecord> {
     ...
     */
    public final TableField<PgPreparedStatementsRecord, Object[]> RESULT_TYPES = createField(DSL.name("result_types"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regtype\"").getArrayDataType(), this, "");
