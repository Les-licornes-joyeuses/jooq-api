...
public class PgPublicationRel extends TableImpl<PgPublicationRelRecord> {
     ...
     */
    public final TableField<PgPublicationRelRecord, Object[]> PRATTRS = createField(DSL.name("prattrs"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").getArrayDataType(), this, "");
