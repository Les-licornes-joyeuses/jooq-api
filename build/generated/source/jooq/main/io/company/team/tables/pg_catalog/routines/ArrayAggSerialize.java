...
public class ArrayAggSerialize extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.array_agg_serialize.RETURN_VALUE</code>.
     */
     ...
     */
    public ArrayAggSerialize() {
        super("array_agg_serialize", PgCatalog.PG_CATALOG, SQLDataType.BLOB);
