...
public class RegexpInstr6 extends AbstractRoutine<Integer> {
    ...
    /**
     * The parameter <code>pg_catalog.regexp_instr._6</code>.
     */
    public static final Parameter<String> _6 = Internal.createParameter("_6", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.regexp_instr._7</code>.
     */
    public static final Parameter<Integer> _7 = Internal.createParameter("_7", SQLDataType.INTEGER, false, true);
     ...
     */
    public void set__7(Integer value) {
        setValue(_7, value);
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public void set__7(Field<Integer> field) {
        setField(_7, field);
    }
}
