...
public class JsonbObjectAggStrict extends AbstractRoutine<JSONB> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.jsonb_object_agg_strict.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonbObjectAggStrict() {
        super("jsonb_object_agg_strict", PgCatalog.PG_CATALOG, SQLDataType.JSONB);
