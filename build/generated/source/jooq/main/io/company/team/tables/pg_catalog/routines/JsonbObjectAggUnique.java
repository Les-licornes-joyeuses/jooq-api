...
public class JsonbObjectAggUnique extends AbstractRoutine<JSONB> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.jsonb_object_agg_unique.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonbObjectAggUnique() {
        super("jsonb_object_agg_unique", PgCatalog.PG_CATALOG, SQLDataType.JSONB);
