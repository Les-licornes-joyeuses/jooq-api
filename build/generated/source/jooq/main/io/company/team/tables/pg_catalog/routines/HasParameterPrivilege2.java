...
public class HasParameterPrivilege2 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.has_parameter_privilege.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>pg_catalog.has_parameter_privilege._1</code>.
     */
    public static final Parameter<Long> _1 = Internal.createParameter("_1", SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.has_parameter_privilege._2</code>.
     */
    public static final Parameter<String> _2 = Internal.createParameter("_2", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.has_parameter_privilege._3</code>.
     */
     ...
     */
    public HasParameterPrivilege2() {
        super("has_parameter_privilege", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
