...
public class JsonObjectAggStrict extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.json_object_agg_strict.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonObjectAggStrict() {
        super("json_object_agg_strict", PgCatalog.PG_CATALOG, SQLDataType.JSON);
