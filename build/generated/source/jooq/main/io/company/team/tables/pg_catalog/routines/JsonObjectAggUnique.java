...
public class JsonObjectAggUnique extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.json_object_agg_unique.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonObjectAggUnique() {
        super("json_object_agg_unique", PgCatalog.PG_CATALOG, SQLDataType.JSON);
