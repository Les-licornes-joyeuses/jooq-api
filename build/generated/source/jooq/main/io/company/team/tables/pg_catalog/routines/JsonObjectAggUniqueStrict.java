...
public class JsonObjectAggUniqueStrict extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.json_object_agg_unique_strict.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonObjectAggUniqueStrict() {
        super("json_object_agg_unique_strict", PgCatalog.PG_CATALOG, SQLDataType.JSON);
