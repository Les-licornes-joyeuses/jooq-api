...
public class PgAttributeRecord extends UpdatableRecordImpl<PgAttributeRecord> {
     ...
     */
    public PgAttributeRecord(Long attrelid, String attname, Long atttypid, Short attlen, Short attnum, Integer attcacheoff, Integer atttypmod, Short attndims, Boolean attbyval, String attalign, String attstorage, String attcompression, Boolean attnotnull, Boolean atthasdef, Boolean atthasmissing, String attidentity, String attgenerated, Boolean attisdropped, Boolean attislocal, Short attinhcount, Short attstattarget, Long attcollation, String[] attacl, String[] attoptions, String[] attfdwoptions, Object[] attmissingval) {
        super(PgAttribute.PG_ATTRIBUTE);
