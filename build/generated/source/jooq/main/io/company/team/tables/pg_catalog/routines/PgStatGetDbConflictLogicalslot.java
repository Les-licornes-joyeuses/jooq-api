...
public class PgStatGetDbConflictLogicalslot extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_logicalslot.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_logicalslot._1</code>.
     */
     ...
     */
    public PgStatGetDbConflictLogicalslot() {
        super("pg_stat_get_db_conflict_logicalslot", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
