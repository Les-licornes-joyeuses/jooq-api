...
public class Erfc extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.erfc.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.erfc._1</code>.
     */
     ...
     */
    public Erfc() {
        super("erfc", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
