...
public class PgStatUserTablesRecord extends TableRecordImpl<PgStatUserTablesRecord> {
     ...
     */
    public PgStatUserTablesRecord(Long relid, String schemaname, String relname, Long seqScan, OffsetDateTime lastSeqScan, Long seqTupRead, Long idxScan, OffsetDateTime lastIdxScan, Long idxTupFetch, Long nTupIns, Long nTupUpd, Long nTupDel, Long nTupHotUpd, Long nTupNewpageUpd, Long nLiveTup, Long nDeadTup, Long nModSinceAnalyze, Long nInsSinceVacuum, OffsetDateTime lastVacuum, OffsetDateTime lastAutovacuum, OffsetDateTime lastAnalyze, OffsetDateTime lastAutoanalyze, Long vacuumCount, Long autovacuumCount, Long analyzeCount, Long autoanalyzeCount) {
        super(PgStatUserTables.PG_STAT_USER_TABLES);
