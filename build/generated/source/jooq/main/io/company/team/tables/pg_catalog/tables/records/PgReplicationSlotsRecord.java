...
public class PgReplicationSlotsRecord extends TableRecordImpl<PgReplicationSlotsRecord> {
     ...
     */
    public PgReplicationSlotsRecord(String slotName, String plugin, String slotType, Long datoid, String database, Boolean temporary, Boolean active, Integer activePid, Long xmin, Long catalogXmin, Object restartLsn, Object confirmedFlushLsn, String walStatus, Long safeWalSize, Boolean twoPhase, Boolean conflicting) {
        super(PgReplicationSlots.PG_REPLICATION_SLOTS);
