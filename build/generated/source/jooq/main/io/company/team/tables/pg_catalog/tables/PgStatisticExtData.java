...
public class PgStatisticExtData extends TableImpl<PgStatisticExtDataRecord> {
     ...
     */
    public final TableField<PgStatisticExtDataRecord, PgStatisticRecord[]> STXDEXPR = createField(DSL.name("stxdexpr"), io.company.team.tables.pg_catalog.tables.PgStatistic.PG_STATISTIC.getDataType().getArrayDataType(), this, "");
