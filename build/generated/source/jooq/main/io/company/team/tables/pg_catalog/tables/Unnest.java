...
public class Unnest extends TableImpl<UnnestRecord> {
     ...
     */
    public final TableField<UnnestRecord, Short[]> POSITIONS = createField(DSL.name("positions"), SQLDataType.SMALLINT.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.unnest.weights</code>.
     */
    public final TableField<UnnestRecord, String[]> WEIGHTS = createField(DSL.name("weights"), SQLDataType.CLOB.getArrayDataType(), this, "");

    private Unnest(Name alias, Table<UnnestRecord> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsvector\""))
        });
    }
