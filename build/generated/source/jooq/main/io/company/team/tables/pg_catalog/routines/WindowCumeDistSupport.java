...
public class WindowCumeDistSupport extends AbstractRoutine<Object> {
     ...
     */
    public WindowCumeDistSupport() {
        super("window_cume_dist_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
