...
public class PgInputIsValid extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.pg_input_is_valid.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>pg_catalog.pg_input_is_valid._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.pg_input_is_valid._2</code>.
     */
     ...
     */
    public PgInputIsValid() {
        super("pg_input_is_valid", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
