...
import io.company.team.tables.pg_catalog.tables.records.PgStatsRecord;
...
public class PgStats extends TableImpl<PgStatsRecord> {
     ...
     */
    public final TableField<PgStatsRecord, Object[]> MOST_COMMON_VALS = createField(DSL.name("most_common_vals"), SQLDataType.OTHER.getArrayDataType(), this, "");
     ...
     */
    public final TableField<PgStatsRecord, Object[]> HISTOGRAM_BOUNDS = createField(DSL.name("histogram_bounds"), SQLDataType.OTHER.getArrayDataType(), this, "");
     ...
     */
    public final TableField<PgStatsRecord, Object[]> MOST_COMMON_ELEMS = createField(DSL.name("most_common_elems"), SQLDataType.OTHER.getArrayDataType(), this, "");
