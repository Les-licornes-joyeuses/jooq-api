...
public class WindowPercentRankSupport extends AbstractRoutine<Object> {
     ...
     */
    public WindowPercentRankSupport() {
        super("window_percent_rank_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
