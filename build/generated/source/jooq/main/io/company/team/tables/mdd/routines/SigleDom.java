...
public class SigleDom extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>MDD.sigle_dom.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>MDD.sigle_dom.t</code>.
     */
     ...
     */
    public SigleDom() {
        super("sigle_dom", Mdd.MDD, SQLDataType.BOOLEAN);
