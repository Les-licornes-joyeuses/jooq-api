...
public class PgBackupStop extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<Boolean> WAIT_FOR_ARCHIVE = Internal.createParameter("wait_for_archive", SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), true, false);
