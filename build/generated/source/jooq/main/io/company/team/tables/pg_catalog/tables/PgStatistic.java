...
public class PgStatistic extends TableImpl<PgStatisticRecord> {
     ...
     */
    public final TableField<PgStatisticRecord, Object[]> STAVALUES1 = createField(DSL.name("stavalues1"), SQLDataType.OTHER.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_statistic.stavalues2</code>.
     */
    public final TableField<PgStatisticRecord, Object[]> STAVALUES2 = createField(DSL.name("stavalues2"), SQLDataType.OTHER.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_statistic.stavalues3</code>.
     */
    public final TableField<PgStatisticRecord, Object[]> STAVALUES3 = createField(DSL.name("stavalues3"), SQLDataType.OTHER.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_statistic.stavalues4</code>.
     */
    public final TableField<PgStatisticRecord, Object[]> STAVALUES4 = createField(DSL.name("stavalues4"), SQLDataType.OTHER.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_statistic.stavalues5</code>.
     */
    public final TableField<PgStatisticRecord, Object[]> STAVALUES5 = createField(DSL.name("stavalues5"), SQLDataType.OTHER.getArrayDataType(), this, "");
