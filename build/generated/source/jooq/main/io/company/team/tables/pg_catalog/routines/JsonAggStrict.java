...
public class JsonAggStrict extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.json_agg_strict.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonAggStrict() {
        super("json_agg_strict", PgCatalog.PG_CATALOG, SQLDataType.JSON);
