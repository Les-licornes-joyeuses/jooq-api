...
public class PgProc extends TableImpl<PgProcRecord> {
     ...
     */
    public final TableField<PgProcRecord, Object[]> PROARGTYPES = createField(DSL.name("proargtypes"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").getArrayDataType(), this, "");
