...
public class RandomNormal extends AbstractRoutine<Double> {
     ...
     */
    public static final Parameter<Double> MEAN = Internal.createParameter("mean", SQLDataType.DOUBLE.defaultValue(DSL.field("0", SQLDataType.DOUBLE)), true, false);

    /**
     * The parameter <code>pg_catalog.random_normal.stddev</code>.
     */
    public static final Parameter<Double> STDDEV = Internal.createParameter("stddev", SQLDataType.DOUBLE.defaultValue(DSL.field("1", SQLDataType.DOUBLE)), true, false);
