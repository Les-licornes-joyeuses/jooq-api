...
public class ArrayAggArraySerialize extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.array_agg_array_serialize.RETURN_VALUE</code>.
     */
     ...
     */
    public ArrayAggArraySerialize() {
        super("array_agg_array_serialize", PgCatalog.PG_CATALOG, SQLDataType.BLOB);
