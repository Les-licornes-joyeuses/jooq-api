...
public class Erf extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.erf.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.erf._1</code>.
     */
     ...
     */
    public Erf() {
        super("erf", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
