...
public class PgTrigger extends TableImpl<PgTriggerRecord> {
     ...
     */
    public final TableField<PgTriggerRecord, Object[]> TGATTR = createField(DSL.name("tgattr"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").getArrayDataType(), this, "");
