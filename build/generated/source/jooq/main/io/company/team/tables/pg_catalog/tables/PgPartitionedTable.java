...
public class PgPartitionedTable extends TableImpl<PgPartitionedTableRecord> {
     ...
     */
    public final TableField<PgPartitionedTableRecord, Object[]> PARTATTRS = createField(DSL.name("partattrs"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_partitioned_table.partclass</code>.
     */
    public final TableField<PgPartitionedTableRecord, Object[]> PARTCLASS = createField(DSL.name("partclass"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_partitioned_table.partcollation</code>.
     */
    public final TableField<PgPartitionedTableRecord, Object[]> PARTCOLLATION = createField(DSL.name("partcollation"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").getArrayDataType(), this, "");
