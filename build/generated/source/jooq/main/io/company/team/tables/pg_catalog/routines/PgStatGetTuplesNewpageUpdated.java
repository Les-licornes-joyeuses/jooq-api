...
public class PgStatGetTuplesNewpageUpdated extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_tuples_newpage_updated.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_tuples_newpage_updated._1</code>.
     */
     ...
     */
    public PgStatGetTuplesNewpageUpdated() {
        super("pg_stat_get_tuples_newpage_updated", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
