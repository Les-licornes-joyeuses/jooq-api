...
public class JsonbAggStrict extends AbstractRoutine<JSONB> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.jsonb_agg_strict.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonbAggStrict() {
        super("jsonb_agg_strict", PgCatalog.PG_CATALOG, SQLDataType.JSONB);
