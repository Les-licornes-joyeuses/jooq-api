...
public class StringAggDeserialize extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.string_agg_deserialize._1</code>.
     */
     ...
     */
    public StringAggDeserialize() {
        super("string_agg_deserialize", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
